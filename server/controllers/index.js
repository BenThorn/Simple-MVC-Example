...
const searchDogName = (req, res) => {
  ...
  return Dog.findByName(req.body.name, (error, doc) => {
    if (error) {
      return res.json({ error }); // if error, return it
    }
    ...
    savePromise.then(() => res.json({ name: doc.name, breed: doc.breed, age: doc.age + 1 }));
